...
const ALUMNI_DATA = [
  ...
  },
  {
    id: 34,
    name: "Shivani R",
    photo: "https://ui-avatars.com/api/?name=Shivani+R&background=1E4FD8&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020 - 2023",
    company: "Straive ",
    position: "Data Analyst",
    careerPath: "Software Trainer ",
    skills: ["SAP", ".NET", "ABAP", "SQL"],
    experience: "1 year",
    contactNumber: "918610261217 ",
    bio: "Specialized in software training and data analysis. Can provide guidance on training methodologies, data analysis techniques, and software development best practices."
  },
  {
    id: 35,
    name: "Guru Prakash",
    photo: "https://ui-avatars.com/api/?name=Guru+Prakash&background=F2B100&color=1a1a1a&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "Vbro systems in Chennai ",
    position: "Junior Desktop Engineer ",
    careerPath: "Automotive Services",
    skills: ["Networking switches", "Desktop support", "Hardware Troubleshooting", "Ticketing Tools", "Field Support"],
    experience: "1 year",
    contactNumber: "919994215483",
    bio: "Specialized in automotive services and desktop engineering. Can provide guidance on networking, hardware troubleshooting, and field support best practices."
  },
  {
    id: 36,
    name: "Rajbharathi R",
    photo: "https://ui-avatars.com/api/?name=Rajbharathi+R&background=0C2461&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "Nippon india mutual funds",
    position: "Relationship Manager ",
    careerPath: "Managerial Services",
    skills: [ "HTML", "CSS" ],
    experience: "2 years",
    contactNumber: "918675240219",
    bio: "Specialized in managerial services and relationship management. Can provide guidance on client relations, financial services, and management best practices."
  },
  {
    id: 37,
    name: ":Anitha V",
    photo: "https://ui-avatars.com/api/?name=Anitha+V&background=1E4FD8&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020 - 2023",
    company: "SBI Bank",
    position: "Current SBI Bank Seva Sarathi",
    careerPath: "Banking Services",
    skills: ["HTML", "CSS", "C", "Excel", "MS Office"],
    experience: "4 years",
    contactNumber: "919345218571",
    bio: "Specialized in banking services and customer support. Can provide guidance on banking operations, financial services, and customer relationship management."
  },
  {
    id: 38,
    name: "Kailash Subramaniyan",
    photo: "https://ui-avatars.com/api/?name=Kailash+Subramaniyan&background=F2B100&color=1a1a1a&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "SkyX Aerospace ",
    position: "Software Developer ",
    careerPath: "Software Development",
    skills: ["TCP/IP", "UDP", "CAN","Qt/C++ Developer – Backend Development", "Qt/QML Developer – Frontend Development", " Frontend Development", "Ticketing Tools", "UART", "MAV Link", "DevOps Consultant", "Technical", "Mentore", "Jenkins","Github", "AWS"],
    experience: "1 year",
    contactNumber: "916382993594",
    bio: "Specialized in software development and application building. Can provide guidance on coding best practices, software design, and development methodologies."
  },
  {
    id: 39,
    name: "Sethuraman M",
    photo: "https://ui-avatars.com/api/?name=Sethuraman+M&background=0C2461&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "Rathinam Technical Campus",
    position: "Technical Mentor",
    careerPath: "Technical Mentoring",
    skills: [ "C", "C++", "Java", "Python", "Go", "DSA", "Big Data Computing", "Meacjine Learning"],
    experience: "1 year",
    contactNumber: "916380144060",
    bio: "Specialized in technical mentoring and training. Can provide guidance on software development, programming, and technical best practices."
  },
  {
    id: 40,
    name: "Hariesh R",
    photo: "https://ui-avatars.com/api/?name=Hariesh+R&background=1E4FD8&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020 - 2023",
    company: "T4TEQ  & jram groups",
    position: " Designer, Content Creator",
    careerPath: "Design and Content Creation",
    skills: ["Video Editing", "Designing", "Content Creation", "social media management", "Photoshop", "Illustrator", "Devinci Resolve", "premiere pro", "After effects"],
    experience: "3 years",
    contactNumber: "916382218158",
    bio: "Specialized in design and content creation. Can provide guidance on video editing, graphic design, and social media management."
  },
  {
    id: 41,
    name: "Arun Prabu ",
    photo: "https://ui-avatars.com/api/?name=Arun+Prabu&background=F2B100&color=1a1a1a&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "Pruvity HR Solutions, Madurai",
    position: "Technical Support",
    careerPath: "Technical Support",
    skills: ["Application Support", "Networking", "Cloud Computing"],
    experience: "1 year",
    contactNumber: "919677834664",
    bio: "Specialized in technical support and application management. Can provide guidance on IT support, networking, and cloud computing best practices."
  },
  {
    id: 42,
    name: "Mohamed Ansar F",
    photo: "https://ui-avatars.com/api/?name=Mohamed+AnsarF&background=0C2461&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "Infinite Computer Solutions ",
    position: "Python Backend Developer",
    careerPath: "Backend Development",
    skills: [ "Python", "FastAPI", "Flask", " REST APIs", "SQL", "Git", "Linux", "AWS (EC2, S3, IAM)", "MongoDB", "Generativ AI", "Mechine Learning", "Deep Learning", "LangChain", "RAG"],
    experience: "3 years",
    contactNumber: "919025657220",
    bio: "Specialized in backend development and application building. Can provide guidance on Python programming, REST API development, and cloud computing best practices."
  },
  {
    id: 43,
    name: "Maydeen Azarudeen ",
    photo: "https://ui-avatars.com/api/?name=Maydeen+Azarudeen&background=1E4FD8&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020 - 2023",
    company: "Medi Assist ",
    ...
    experience: "3 years",
    contactNumber: "919500941853",
    bio: "Specialized in data engineering and cloud computing. Can provide guidance on Python programming, SQL, and cloud technologies."
  },
  {
    id: 44,
    name: "Siva R",
    photo: "https://ui-avatars.com/api/?name=Siva+R&background=F2B100&color=1a1a1a&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "Stackly",
    position: "AWS and Devops Engineering",
    careerPath: "AWS and DevOps",
    skills: ["AWS", "DevOps"],
    experience: "1 year",
    contactNumber: "919384158587",
    bio: "Specialized in AWS and DevOps engineering. Can provide guidance on cloud infrastructure, continuous integration, and deployment best practices."
  },
  {
    id: 45,
    name: "Loganathan D",
    photo: "https://ui-avatars.com/api/?name=Loganathan+D&background=0C2461&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "Chennai",
    position: "Data Analyst ",
    careerPath: "Data Analyst",
    skills: [ "Python", "HTML", "CSS", "Frappe Framework", "ERPNext", "MariaDB", "MySQL", "SQL"],
    experience: "1 year",
    contactNumber: "918220101979",
    bio: "Specialized in data analysis and managerial services. Can provide guidance on data analysis techniques, software development, and management best practices."
  },
  {
    id: 46,
    name: "Kavinesh S",
    photo: "https://ui-avatars.com/api/?name=Kavinesh+S&background=1E4FD8&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020 - 2023",
    company: "Stackly (WFH)",
    position: "AWS Devops Engineer",
    careerPath: "AWS and DevOps",
    skills: ["Devops", "Cloud Computing", "Networking", "Python", "Operation System"],
    experience: "1 year",
    contactNumber: "916384713244",
    bio: "Specialized in AWS DevOps engineering and cloud computing. Can provide guidance on cloud infrastructure, continuous integration, and deployment best practices."
  },
  {
    id: 47,
    name: "Abdul Rajak S",
    photo: "https://ui-avatars.com/api/?name=Abdul+RajakS&background=F2B100&color=1a1a1a&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "Stackly",
    position: "AWS and Devops Engineer",
    careerPath: "AWS and DevOps",
    skills: ["AWS", "DevOps"],
    experience: "1 year",
    contactNumber: "919787614312",
    bio: "Specialized in AWS and DevOps engineering. Can provide guidance on cloud infrastructure, continuous integration, and deployment best practices."
  },
  {
    id: 48,
    name: "Thirugnanam P",
    photo: "https://ui-avatars.com/api/?name=Thirugnanam+P&background=0C2461&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "Allset Business Solution",
    position: "Team leader",
    careerPath: "Business services",
    skills: [ "Collection", "Team Leadership"],
    experience: "2 years",
    contactNumber: "916369248446",
    bio: "Specialized in data analysis and team leadership. Can provide guidance on data collection, analysis techniques, and team management best practices."
  },
  {
    id: 49,
    name: "Jeysaravanan S",
    photo: "https://ui-avatars.com/api/?name=Jeysaravanan+S&background=1E4FD8&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020 - 2023",
    company: "Siam Computing ",
    position: "Product Manager",
    careerPath: "Product Management",
    skills: ["Product management", "PRD", "SDLC", "Requirement gathering", "Wireframing", "Agile", "Cross team collaboration", "Stakeholder Management"],
    experience: "1 year",
    contactNumber: "919159322662",
    bio: "Specialized in product management and software development. Can provide guidance on product strategy, requirement gathering, and cross-team collaboration best practices."
  },
  {
    id: 50,
    name: "Naveenkumar Manivannan",
    photo: "https://ui-avatars.com/api/?name=Naveenkumar+Manivannan&background=F2B100&color=1a1a1a&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "Ceiyone Tech Works",
    position: "Software Engineer",
    careerPath: "Software Development",
    skills: [".Net", "React", "Angular", "SQL"],
    experience: "3 years",
    contactNumber: "919789326736",
    bio: "Specialized in software development and application building. Can provide guidance on coding best practices, software design, and development methodologies."
  },
  {
    id: 51,
    name: "Santhosh O",
    photo: "https://ui-avatars.com/api/?name=Santhosh+O&background=0C2461&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "Coimbutore",
    position: "Software Engineer",
    careerPath: "Software Development",
  ...
  {
    id: 53,
    name: "Mohanraj sampath",
    photo: "https://ui-avatars.com/api/?name=Mohanraj+Sampath&background=F2B100&color=1a1a1a&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "Deutsche Bank",
    position: "Documentary trade analyst",
    careerPath: "Documentary Trade Analysis",
    skills: ["Ms office", "Financial Crime", "Risk Management", "Swift messaging","protocol", "Documentary trade products" , "International trade", "Financial Crime","Data analytics"],
    experience: "3 years",
    contactNumber: "917708171361",
    bio: "Specialized in documentary trade analysis and financial operations. Can provide guidance on trade documentation, risk assessment, and international trade processes."
  },
  {
    id: 54,
    name: "Thangavel",
    photo: "https://ui-avatars.com/api/?name=Thangavel&background=0C2461&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "Thillainagar Trichy",
    position: ".NET Developer",
    careerPath: "Software Development",
    skills: [  "HTML", "CSS","JavaScript", "MySQL", "C#"],
    experience: "2 years",
    contactNumber: "919360083256",
    bio: "Specialized in software development and application building. Can provide guidance on coding best practices, software design, and development methodologies."
  },
  {
    id: 55,
    name: "Premkumar",
    photo: "https://ui-avatars.com/api/?name=PREMKUMAR+&background=1E4FD8&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020 - 2023",
    company: "Chennai",
    position: "junior Devops",
    careerPath: "Procurement Management",
    skills: ["AWS", "Docker", "Kubernetes", "Jenkins", "CI/CD", "Azure"],
    experience: "1 year",
    contactNumber: "919361365693",
    bio: "Specialized in DevOps and cloud computing. Can provide guidance on continuous integration, deployment strategies, and cloud infrastructure management."
  },
  {
    id: 56,
    name: "T Nithish ",
    photo: "https://ui-avatars.com/api/?name=T+Nithish+&background=F2B100&color=1a1a1a&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "Beyondexs private limited ",
    position: "Full Stack Developer ",
    careerPath: "Software Development",
    skills: ["HTML", "CSS","JavaScript", "MySQL", "C#","Bootstrap", ".NET Framework", ".NET Core", "PHP","React.js"],
    experience: "3 years",
    contactNumber: "919159464188",
    bio: "Specialized in full stack development with a focus on .NET and React.js. Can provide guidance on front-end frameworks, application architecture, and best practices in web development."
  },
  {
    id: 57,
    name: "Tamilselvan S",
    photo: "https://ui-avatars.com/api/?name=Tamilselvan+S&background=0C2461&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "Salem",
    position: "Aws devops enginner",
    careerPath: "Software Development",
    skills: [  "Cloud (AWS SERVICES)", "Jenkins","Docker", "Kubernetes", "Ansible", "Terraform", "ArgoCD", "Prometheus", "Grafana"],
    experience: "1 year",
    contactNumber: "916379057336",
    bio: "Specialized in software development and application building. Can provide guidance on coding best practices, software design, and development methodologies."
  },
  {
    id: 58,
    name: "M Vishwa",
    photo: "https://ui-avatars.com/api/?name=M+Vishwa&background=1E4FD8&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020 - 2023",
    company: "Chennai",
    position: "Frontend developer ",
    careerPath: "Software Development",
    skills: ["HTML", "CSS", "JavaScript", "React.js", "Bootstrap", "Java"],
    experience: "1 year",
    contactNumber: "918870283954",
    bio: "Specialized in frontend development and application building. Can provide guidance on coding best practices, software design, and development methodologies."
  },
  {
    id: 59,
    name: "Arunkumar",
    photo: "https://ui-avatars.com/api/?name=Arunkumar&background=F2B100&color=1a1a1a&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "Convert tech solutions ",
    position: "Document Analyst ",
    careerPath: "Documentary Trade Analysis",
    skills: ["Ms office", "Excel", "Word Knowledge"],
    experience: "3 years",
    contactNumber: "918838861835",
    bio: "Specialized in documentary trade analysis and document management. Can provide guidance on document processing, data entry, and office software best practices."
  },
  {
    id: 60,
    name: "Venkatesan G",
    photo: "https://ui-avatars.com/api/?name=Venkatesan+G&background=0C2461&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "Vdarts private limited ",
    position: "Talent acquisition (Recruiter)",
    careerPath: "HR and Recruitment",
    skills: [  "HR tag human Resource"],
    experience: "2 years",
    contactNumber: "916369453715",
    bio: "Specialized in HR and recruitment. Can provide guidance on talent acquisition, employee relations, and organizational development."
  },
  {
    id: 61,
    name: "Gnanaprathap",
    photo: "https://ui-avatars.com/api/?name=Gnanaprathap&background=1E4FD8&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020 - 2023",
    company: "Chennai",
    position: "Senior Executive ",
    careerPath: "Software Development",
    skills: ["AWS", "Gen AI", "SQL", "Python", "Lambda", "MS Office", "Power BI", "LLM", "Rag","Django"],
    experience: "2 years",
    contactNumber: "919791660473",
    bio: "Specialized in software development and application building. Can provide guidance on coding best practices, software design, and development methodologies."
  },
  {
    id: 62,
    name: "Rajeshkumar",
    photo: "https://ui-avatars.com/api/?name=Rajeshkumar&background=F2B100&color=1a1a1a&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "Clear Aqua Technologies",
    position: "Sys Admin & Deaktop Support",
    careerPath: "IT Support and System Administration",
    skills: ["Networking", "Linux"],
    experience: "1 year",
    contactNumber: "916374461781",
    bio: "Specialized in IT support and system administration. Can provide guidance on network management, Linux administration, and IT troubleshooting best practices."
  },
  {
    id: 63,
    name: "Gowsik Velan AK",
    photo: "https://ui-avatars.com/api/?name=Gowsik+VelanAK&background=0C2461&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020  - 2023",
    company: "SURYAN FM TRICHY",
    position: "RADIO JOCKEY AND MUSIC MANAGER ",
    careerPath: "FM Management",
    skills: ["HTML", "ML", "Python", "Voice Artist", "Content Creater"],
    experience: "1 year",
    contactNumber: " 919047364771",
    bio: "Specialized in FM and i am expert in the Voice Artict. And i am expert in the content creating"
  },
  {
    id: 64,
    name: "Akkim K",
    photo: "https://ui-avatars.com/api/?name=Akkim+K&background=1E4FD8&color=fff&size=200&font-size=0.36&bold=true",
    batch: "2020 - 2023",
    company: "ArcGX Tech labs",
    position: "GIS Analysts ",
    careerPath: "Data Analyst",
    skills: ["HTML", "CSS", "Data Analyst"],
    experience: "1 year",
    contactNumber: "919344467155",
    bio: "Specialized in Data Analyst and Expert on this Feild. Can provide guidance on Data Analyst best practices, Analysting methodologies."
  },
];
...
function renderHeroStats(alumniList) {
  ...
  const stats = [
    ...
    { value: "2018-2025", label: "Batches Covered" }
  ];
